...
public class FileController {
    ...
    public R selectFileList(@RequestBody QueryInfo query){
...
//        return R.ok().data("pageResult",pageResult);
    ...
    public void download2(HttpServletRequest req, HttpServletResponse resp,@RequestParam("location") String location,@RequestParam("filename") String fileName){
        BufferedInputStream bis = null;
        BufferedOutputStream bos = null;
        OutputStream fos = null;
        try {
    ...
    public void download3(HttpServletRequest req, HttpServletResponse resp){
        String location = req.getParameter("location");

        ServletUtil.write(resp,FileUtil.getInputStream(location),"application/zip");
        //return R.ok().data("data",FileUtil.readBytes(location));
    ...
    public R deleteFile(@RequestBody TFileInfo tFileInfo ){
